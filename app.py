...
if st.button("Prämie berechnen"):
    ...
    "alter_liste": alter_liste,
    "max_alter": max_alter,
    "rrv_ev_mit": berechne_praemie(rrv_ev_mit, preis=reisepreis),
    "rrv_ev_ohne": berechne_praemie(rrv_ev_ohne, preis=reisepreis),
    "rrv_jv_mit": rrv_jv_mit["Prämie"],
    "rrv_jv_ohne": rrv_jv_ohne["Prämie"],
    "spf_mit": spf_mit["Prämie"],
    "spf_ohne": spf_ohne["Prämie"],
    "kranken_mit": kranken_mit,
    "kranken_ohne": kranken_ohne,
    "kv_jv_mit": kv_jv_mit["Prämie"],
    "kv_jv_ohne": kv_jv_ohne["Prämie"],
    "rus_ev_mit": berechne_praemie(rus_ev_mit, preis=reisepreis),
    "rus_ev_ohne": berechne_praemie(rus_ev_ohne, preis=reisepreis),
    "rus_jv_mit": rus_jv_mit["Prämie"],
    "rus_jv_ohne": rus_jv_ohne["Prämie"]
}
