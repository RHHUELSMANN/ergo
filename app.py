...
if st.button("Prämie berechnen"):
    if reisepreis and alter_input and reise_von and reise_bis:
        ...
        st.session_state["word_data"] = {
            ...
            "rrv_ev_mit": berechne_praemie(rrv_ev_mit, preis=reisepreis), "rrv_ev_ohne": berechne_praemie(rrv_ev_ohne, preis=reisepreis),
            ...
            "rus_ev_mit": berechne_praemie(rus_ev_mit, preis=reisepreis), "rus_ev_ohne": berechne_praemie(rus_ev_ohne, preis=reisepreis),
